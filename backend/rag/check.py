...
if __name__ == "__main__":
    # print(answer_query("Who is Santosh?"))
    # print(answer_query("What does he do?"))
    print(answer_query("What is this research paper about?"))
    print(answer_query("How many people contributed to the research paper?"))
    print(answer_query("Is he junior or senior level?"))